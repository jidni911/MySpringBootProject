        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <body>
                ...
                <div class="container mt-5">
                    ...
                    <% String greetingMessage="Hello, this is a simple JSP page!" ; out.println("<p>" + greetingMessage
                        + "</p>");
                        %>
                        ...
                        <a href="${pageContext.request.contextPath}/add" class="btn btn-success mt-3">Add New
                            Employee</a>
                        <a href="${pageContext.request.contextPath}/addrandom" class="btn btn-success mt-3">Add Random
                            Employee</a>
